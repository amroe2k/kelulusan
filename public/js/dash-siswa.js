...
function renderSiswaTable(list){
  ...
  paginatedRows.forEach(s=>{
    ...
    tr.innerHTML=`
      ...
      <td class="px-4 py-3"><p class="text-sm font-bold text-white">${s.nama}</p><div class="flex items-center gap-1.5 group mt-1"><span class="inline-flex items-center px-2 py-0.5 rounded bg-slate-500/10 text-slate-400 border border-slate-500/20 text-xs font-mono leading-none">${s.nisn||'-'}</span>${s.nisn?`<button class="copy-nisn opacity-0 group-hover:opacity-100 transition-opacity p-0.5 rounded hover:bg-slate-700/50 text-slate-400 hover:text-indigo-400" data-nisn="${s.nisn}" title="Salin NISN"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg></button>`:''}</div></td>
