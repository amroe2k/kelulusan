...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $fields = ['sekolah','npsn','nss','jenjang','kompetensi_keahlian','tahun_ajaran','alamat','kota','kepala_sekolah','jabatan_kepsek','nip_kepsek','nuptk_kepsek','id_kepsek_mode','tanggal_pengumuman','nomor_surat_suffix','nomor_surat_mode','nomor_surat_statis','tanggal_skl2','telepon','email','domain'];
    $sets = []; $vals = [];
    foreach($fields as $f){
